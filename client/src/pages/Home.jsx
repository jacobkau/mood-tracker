...
const Home = () => {
  ...
  return (
    <div className={`${currentTheme.bodyBg} ${currentTheme.bodyText} min-h-screen flex flex-col`}>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6 leading-tight">
              ...
              <span className={`${currentTheme.bodyAccent}`}> Improve Your Well-being</span>
            </h2>
            ...
            <div className="mt-8 flex items-center opacity-80">
              <div className="flex -space-x-2 mr-4">
                <div className={`w-8 h-8 rounded-full ${currentTheme.highlight} border-2 border-white`}></div>
                <div className={`w-8 h-8 rounded-full ${currentTheme.highlight} border-2 border-white`}></div>
                <div className={`w-8 h-8 rounded-full ${currentTheme.highlight} border-2 border-white`}></div>
              </div>
              <p>Join <span className={`font-semibold ${currentTheme.bodyAccent}`}>5,000+</span> users tracking their mood daily</p>
            </div>
          </div>
          
          <div className="relative">
            <div className={`${currentTheme.cardBg} p-6 rounded-2xl ${currentTheme.cardShadow} ${currentTheme.cardBorder} border transform rotate-2`}>
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-semibold">Today's Mood</h3>
                <span className={`text-sm ${currentTheme.bodyAccent}`}>June 12, 2023</span>
              </div>
              <div className="flex justify-center mb-6">
                <div className={`w-24 h-24 bg-gradient-to-r ${currentTheme.headerGradient} rounded-full flex items-center justify-center text-white text-4xl`}>
                  😊
                </div>
              </div>
              <div className={`${currentTheme.highlight} p-4 rounded-lg`}>
                <p className="text-sm">"Had a productive day at work and enjoyed my evening walk. Feeling balanced and content."</p>
              </div>
            </div>
            
            {/* Decorative elements */}
            <div className={`absolute -top-4 -right-4 w-20 h-20 ${currentTheme.highlight} rounded-full blur-xl opacity-70 z-0`}></div>
            <div className={`absolute -bottom-4 -left-4 w-24 h-24 ${currentTheme.highlight} rounded-full blur-xl opacity-70 z-0`}></div>
          </div>
        </div>
      </main>

      {/* Stats Section */}
      <section className={`py-12 ${currentTheme.cardBg}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className={`text-3xl md:text-4xl font-bold ${currentTheme.bodyAccent}`}>92%</div>
              <div className="mt-2 opacity-80">Users report better mood awareness</div>
            </div>
            <div>
              <div className={`text-3xl md:text-4xl font-bold ${currentTheme.bodyAccent}`}>30+</div>
              <div className="mt-2 opacity-80">Mood indicators tracked</div>
            </div>
            <div>
              <div className={`text-3xl md:text-4xl font-bold ${currentTheme.bodyAccent}`}>10K+</div>
              <div className="mt-2 opacity-80">Mood entries logged</div>
            </div>
            <div>
              <div className={`text-3xl md:text-4xl font-bold ${currentTheme.bodyAccent}`}>24/7</div>
              <div className="mt-2 opacity-80">Secure data protection</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Features Section */}
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${currentTheme.highlight}`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How Witty MoodTracker Helps You</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className={`${currentTheme.cardBg} p-6 rounded-xl ${currentTheme.cardShadow} ${currentTheme.cardBorder} border hover:shadow-lg transition-all duration-300`}>
              <div className={`${currentTheme.highlight} rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4`}>
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-center">Easy Tracking</h3>
            ...
            <div className={`${currentTheme.cardBg} p-6 rounded-xl ${currentTheme.cardShadow} ${currentTheme.cardBorder} border hover:shadow-lg transition-all duration-300`}>
              ...
              <h3 className="text-xl font-semibold mb-3 text-center">Insightful Analytics</h3>
              <p className="mb-4 opacity-90">
      ...
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${currentTheme.cardBg}`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">What Our Users Say</h2>
            <p className="text-xl opacity-90">Join thousands of users who have transformed their emotional awareness</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className={`${currentTheme.highlight} p-6 rounded-xl`}>
              <div className="flex items-center mb-4">
                <div className={`w-12 h-12 ${currentTheme.highlight} rounded-full flex items-center justify-center font-bold mr-4`}>JD</div>
                <div>
                  <h4 className="font-semibold">James D.</h4>
                  <div className={`flex ${currentTheme.bodyAccent}`}>
                    ★★★★★
                  </div>
                </div>
              </div>
            ...
            <div className={`${currentTheme.highlight} p-6 rounded-xl`}>
              <div className="flex items-center mb-4">
                <div className={`w-12 h-12 ${currentTheme.highlight} rounded-full flex items-center justify-center font-bold mr-4`}>SR</div>
                <div>
            ...
            <div className={`${currentTheme.highlight} p-6 rounded-xl`}>
              <div className="flex items-center mb-4">
                <div className={`w-12 h-12 ${currentTheme.highlight} rounded-full flex items-center justify-center font-bold mr-4`}>MJ</div>
                <div>
      ...
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${currentTheme.highlight}`}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl opacity-90">Everything you need to know about Witty MoodTracker</p>
          </div>
          
          <div className="space-y-6">
            <div className={`${currentTheme.cardBg} p-6 rounded-xl ${currentTheme.cardShadow} ${currentTheme.cardBorder} border`}>
              <h3 className={`text-lg font-semibold ${currentTheme.bodySecondary} mb-2`}>How does mood tracking help me?</h3>
              <p className="opacity-90">
            ...
            <div className={`${currentTheme.cardBg} p-6 rounded-xl ${currentTheme.cardShadow} ${currentTheme.cardBorder} border`}>
              <h3 className={`text-lg font-semibold ${currentTheme.bodySecondary} mb-2`}>Is my data private?</h3>
              <p className="opacity-90">
            ...
            <div className={`${currentTheme.cardBg} p-6 rounded-xl ${currentTheme.cardShadow} ${currentTheme.cardBorder} border`}>
              <h3 className={`text-lg font-semibold ${currentTheme.bodySecondary} mb-2`}>Can I use Witty MoodTracker for free?</h3>
              <p className="opacity-90">
